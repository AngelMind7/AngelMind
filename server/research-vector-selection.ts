...
const fingerprintRules: Array<{
  ...
  { needles: ["upload", "multipart", "file upload"], vectors: [{ vectorKey: "file-upload-abuse", capability: "file-upload-testing", suggestedAdapters: ["burp_pro_adapter", "custom_scripts"], riskClass: "critical", rationale: "Fitur upload ditemukan; validasi tetap pasif sampai approval." }] },
