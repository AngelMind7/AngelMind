...
The current AI-core foundation is implemented in `apps/orchestrator-langgraph/` as a Python, network-free reference package. It contains typed contracts, deterministic guardrails, and offline rehearsal only.
