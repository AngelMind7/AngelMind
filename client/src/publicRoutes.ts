...
export const publicRoutes = [
  ...
  { path: "/bug-bounty", component: PublicInfoPage, boundary: "reviewed-static-copy" },
  { path: "/researchers", component: PublicInfoPage, boundary: "reviewed-static-copy" },
  { path: "/for-researchers", component: PublicInfoPage, boundary: "reviewed-static-copy" },
  { path: "/trust", component: TrustCenter, boundary: "implemented-control-inventory" },
  { path: "/trust-center", component: TrustCenter, boundary: "implemented-control-inventory" },
  ...
  { path: "/legal/privacy", component: PublicInfoPage, boundary: "deployment-reviewed-legal-copy" },
  { path: "/legal/terms", component: PublicInfoPage, boundary: "deployment-reviewed-legal-copy" },
  { path: "/legal/cookies", component: PublicInfoPage, boundary: "deployment-reviewed-legal-copy" },
