...
const routes = read("apps/frontend-angular/src/publicRoutes.ts");
const sitemap = read("apps/frontend-angular/public/sitemap.xml");
const robots = read("apps/frontend-angular/public/robots.txt");
const index = read("apps/frontend-angular/index.html");
