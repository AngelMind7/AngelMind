...
const failures = [];
const requiredFiles = ["src/c2/server/ai-automation.ts", "src/c2/server/rest-v1-ai-automation.ts", "src/c2/server/ai-platform.ts", "src/c2/server/ai-routing.ts", "docs/domain/13-ai-automation.md"];
for (const file of requiredFiles) if (!existsSync(resolve(root, file))) failures.push(`missing ${file}`);
const service = read("src/c2/server/ai-automation.ts");
...
const rest = read("src/c2/server/rest-v1-ai-automation.ts");
