...
export const routedProcedurePermissions = {
  "auth.me": "public", "auth.logout": "public", "agent.analyzeEvidence": "authenticated", "agent.analyzeAndCreateFinding": "authenticated", "agent.importPassiveInventory": "authenticated", "control.dashboard": "authenticated",
