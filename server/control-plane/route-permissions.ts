...
export const routedProcedurePermissions = {
  "auth.me": "public", "auth.logout": "public", "agent.analyzeEvidence": "authenticated", "agent.analyzeAndCreateFinding": "authenticated", "agent.importPassiveInventory": "authenticated", "agent.composeReport": "authenticated", "agent.validateReport": "authenticated", "agent.extractArtifact": "authenticated", "agent.analytics": "read-member", "agent.importWorkspaceInventory": "owner", "agent.listWorkspaceInventory": "read-member", "agent.saveReportVersion": "owner", "agent.listReportVersions": "read-member", "control.dashboard": "authenticated",
  ...
  "operations.members": "owner", "operations.addMember": "owner", "operations.removeMember": "owner", "operations.webhook": "owner", "operations.saveWebhookDraft": "owner", "operations.archives": "owner", "operations.createArchive": "owner", "operations.verifyArchive": "owner", "operations.restoreArchivePlan": "owner",
  ...
  "finding.comments": "read-member", "finding.addComment": "read-member", "evidence.duplicateCandidates": "read-member", "search.global": "read-member", "knowledge.graph": "read-member", "knowledge.upsertNode": "responder", "knowledge.createEdge": "responder", "knowledge.traverse": "read-member", "research.ingestIntelligenceFeed": "responder", "research.enqueueIntelligenceFetch": "responder", "research.promoteObservationToFinding": "responder", "research.playbookRuns": "read-member", "research.transitionPlaybookRun": "responder", "organization.previewProgramScope": "read-member", "organization.submissions": "read-member", "organization.submissionEvents": "read-member", "organization.createSubmission": "responder", "organization.transitionSubmission": "responder", "governance.list": "admin-or-distinct-reviewer", "governance.requestTier3": "owner", "governance.decide": "admin-or-distinct-reviewer",
