...
const required = [
  ["src/c2/server/bug-bounty.ts", ["Program Management", "Researcher Onboarding", "Submission Portal", "Reward System", "Leaderboard", "Coordinated Disclosure", "Legal", "Hall of Fame"]],
  ["src/c2/server/rest-v1-bug-bounty.ts", ["/api/v1/bugbounty/programs", "/api/v1/bugbounty/programs/:id/submission", "/api/v1/bugbounty/submissions/:id/validate", "/api/v1/bugbounty/submissions/:id/payout"]],
  ["src/c2/server/bug-bounty.test.ts", ["bug bounty domain"]],
...
const routeText = fs.readFileSync("src/c2/server/rest-v1-bug-bounty.ts", "utf8");
