...
const english = { "nav.controlPlane": "Control plane", "nav.commandCenter": "Command center", "nav.mission": "Mission control", "nav.workspaces": "Workspaces", "nav.organizations": "Organizations", "nav.researcher": "Researcher hub", "nav.aiCenter": "AI center", "nav.research": "Research", "nav.knowledge": "Knowledge graph", "nav.reports": "Reports", "nav.inventory": "Asset inventory", "nav.security": "Security center", "nav.profile": "Profile", "nav.governance": "Governance", "nav.findings": "Findings", "nav.audit": "Evidence & audit", "nav.observability": "Observability", "nav.operations": "Operations console", "nav.assurance": "Assurance control", "nav.notifications": "Notifications", "nav.menu": "Menu", "auth.signIn": "Sign in", "auth.signOut": "Sign out", "auth.signInTitle": "Sign in to continue", "auth.signInText": "Access to this dashboard requires authentication. Continue to launch the login flow.", "locale.language": "Language", "locale.timeZone": "Time zone", "common.selectWorkspace": "Select workspace", "common.approve": "Approve", "common.reject": "Reject", "common.create": "Create", "common.resolve": "Resolve", "common.link": "Link", "status.pending": "Pending", "status.disabled": "Disabled" } as const;
