...
export const authenticatedRoutes = [
  ...
  { path: "/research/:id/executions", component: research },
  { path: "/research/:id/observations", component: research },
  { path: "/research/:id/evidence", component: research },
  ...
  { path: "/operations/workers", component: operations },
  { path: "/operations-console", component: operationsAdmin },
  ...
  { path: "/security/mfa", component: security },
  { path: "/security/history", component: security },
  ...
  { path: "/settings/team", component: profile },
  { path: "/settings/policies", component: profile },
  { path: "/settings/credentials", component: profile },
  { path: "/settings/preferences", component: profile },
  { path: "/settings/integrations", component: profile },
  { path: "/settings/integrations/new", component: profile },
  { path: "/settings/developer", component: profile },
  { path: "/settings/developer/sdk", component: profile },
  { path: "/settings/developer/keys", component: profile },
  { path: "/settings/developer/logs", component: profile },
  { path: "/settings/billing", component: profile },
  { path: "/settings/billing/invoices", component: profile },
  { path: "/settings/billing/payment", component: profile },
  { path: "/settings/billing/upgrade", component: profile },
  { path: "/privacy", component: profile },
  { path: "/privacy/export", component: profile },
  { path: "/privacy/delete", component: profile },
  { path: "/privacy/requests", component: profile },
  { path: "/privacy/downloads", component: profile },
] as const;
