...
export const routedProcedurePermissions = {
  ...
  "finding.comments": "read-member", "finding.addComment": "read-member", "evidence.duplicateCandidates": "read-member", "search.global": "read-member", "knowledge.graph": "read-member", "knowledge.upsertNode": "responder", "knowledge.createEdge": "responder", "knowledge.traverse": "read-member", "research.ingestIntelligenceFeed": "responder", "organization.previewProgramScope": "read-member", "organization.submissions": "read-member", "organization.submissionEvents": "read-member", "organization.createSubmission": "responder", "organization.transitionSubmission": "responder", "governance.list": "admin-or-distinct-reviewer", "governance.requestTier3": "owner", "governance.decide": "admin-or-distinct-reviewer",
