...
| 16 | Asset intelligence | **Partial** | Passive assets/import, deterministic hostname dedupe, active/stale discovery delta, first/last-seen timestamps, SHA-256 discovery-run summaries, scope filtering, and four-method target verification are implemented; relationship graph plus domain/technology/service inventory remain open. |
