...
export const researchObservations = mysqlTable("researchObservations", {
  ...
  sourceType: varchar("sourceType", { length: 80 }).default("manual").notNull(),
  sourceReference: varchar("sourceReference", { length: 512 }),
  rawOutputSha256: varchar("rawOutputSha256", { length: 64 }),
  normalizedEvidenceSha256: varchar("normalizedEvidenceSha256", { length: 64 }),
