...
| 97 | Supply-chain security | **Partial** | Lockfile, dependency review/security workflow, pinned CycloneDX SBOM generation/upload, pinned HIGH/CRITICAL Trivy image scan evidence, and container hardening are implemented; image signing/verification and full DAST remain open. |
