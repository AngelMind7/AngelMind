...
console.log(`Master contract OK: ${routes.length} routes, 14 domains, ${(catalog.match(/"toolKey"\s*:/g) ?? []).length} UTF modules, ${schemas.length} evidence schemas, >=47 correlation rules, ${migrations.length} migrations.`);
