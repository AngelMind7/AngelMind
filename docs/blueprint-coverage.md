...
| 97 | Supply-chain security | **Partial** | Lockfile, dependency review/security workflow, pinned CycloneDX SBOM generation/upload for runtime images, and container hardening are implemented; image signing/verification and full DAST remain open. |
