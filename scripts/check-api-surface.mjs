...
// Count procedure declarations in the canonical router source. This deliberately
// counts executable tRPC leaves, not documentation/contract placeholders.
