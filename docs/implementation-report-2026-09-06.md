...
Commit lanjutan yang dipublish: `ed42302` (domain dan persistence), `fdb22db` (coverage/report), dan `a8d758a` (permission contract tests). Full Vitest lulus dengan **140 test files passed, 3 skipped; 464 tests passed, 3 skipped**. Production build dan bundle budget lulus; warning circular chunk tetap merupakan warning existing yang tidak menembus budget. Working tree `main` bersih dan sinkron dengan `origin/main`.
